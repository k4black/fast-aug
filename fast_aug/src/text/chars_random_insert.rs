...
/// Augmenter that inserts random chars in random words in text
///
/// # Examples
/// ```rust
/// use fast_aug::base::BaseAugmenter;
/// use fast_aug::models::text::AlphabetModel;
/// use fast_aug::text::{CharsRandomInsertAugmenter, TextAugmentParameters};
///
/// let rng = &mut rand::thread_rng();
/// let alphabet_model = AlphabetModel::from_locale_str("en");
/// let augmenter = CharsRandomInsertAugmenter::new(
...
/// ```
pub struct CharsRandomInsertAugmenter {
...
impl CharsRandomInsertAugmenter {
    pub fn new(
        word_params: TextAugmentParameters,
        char_params: TextAugmentParameters,
        alphabet_model: AlphabetModel,
...
impl BaseTextAugmenter for CharsRandomInsertAugmenter {}

impl BaseAugmenter<String, Doc> for CharsRandomInsertAugmenter {
...
mod tests {
    ...
    fn test_insert(input_tokens: Vec<&str>, words_p: f32, chars_p: f32, expected_doc_changes: usize) {
        ...
        let alphabet_model = AlphabetModel::from_locale_str("en");
        let aug = CharsRandomInsertAugmenter::new(words_params, chars_params, alphabet_model, None);
